/**
 * SpeckleViewer - Переиспользуемый компонент для 3D визуализации Speckle моделей
 * Используется в: Program page, Assembly card, ViewerPage
 */
...
const SPECKLE_TOKEN = "95184e89f7abe8d350cc6bb70ce69b606dba95b7bf";
